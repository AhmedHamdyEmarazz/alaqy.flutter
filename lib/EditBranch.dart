...
class EditBranch extends StatefulWidget {
  static const routeName = '/EditBranch';

  @override
  EditBranchState createState() => EditBranchState();
}

class EditBranchState extends State<EditBranch> {
...
//  ) async {
  ...
  void _sendMessage() async {
    ...
    FirebaseFirestore.instance.collection('branches').add({
      ...
      'branch_name': _enteredMessagename.trim(),
