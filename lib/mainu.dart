...
class MyHomePagez extends StatefulWidget {
  ...
  @override
  State<MyHomePagez> createState() => _MyHomePagezState();
}
...
class _MyHomePagezState extends State<MyHomePagez> with WidgetsBindingObserver {
  var bus = false;
  @override
  void initState() {
    super.initState();
