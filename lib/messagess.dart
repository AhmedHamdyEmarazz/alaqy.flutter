  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder(
        ...
        builder: (ctx, chatSnapshottt) {
          ...
          chatDocs.removeWhere((element) =>
              element.data()['to'] == FirebaseAuth.instance.currentUser!.uid &&
              element.data()['text'].toString().endsWith('permission') == true);
          ...
          return ListView.builder(
            ...
            itemBuilder: (ctx, index) => chatDocs[index]['to'] ==
                        FirebaseAuth.instance.currentUser!.uid &&
                    chatDocs[index]['text'].toString().endsWith('permission') ==
                        true
                ? SizedBox()
                : MessageBubbles(
                    chatDocs[index]['text'],
