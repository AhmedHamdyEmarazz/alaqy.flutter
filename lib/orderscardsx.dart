...
class OrdersCardsx extends StatefulWidget {
  static const routeName = '/OrdersCardsx';

  const OrdersCardsx({super.key});
  // final String oppi;
//  final String oppoo;

//  Messagess(this.oppoo, this.oppi);
  @override
  State<OrdersCardsx> createState() => OrdersCardsxState();
}

class OrdersCardsxState extends State<OrdersCardsx> {
  dynamic report;
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder(
        ...
        builder: (ctx, chatSnapshottt) {
          ...
          if (!chatSnapshottt.hasData) {
            return SplashScreen();
          }
          if (AsyncSnapshot.waiting().hasError) {
            return SplashScreen();
          }
          final chatDocss =
